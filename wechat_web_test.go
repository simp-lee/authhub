...
var _ Provider = (*wechatWebProvider)(nil)

// ---------------------------------------------------------------------------
// NewWechatWeb — constructor validation
// ---------------------------------------------------------------------------

func TestNewWechatWeb_Success(t *testing.T) {
	p, err := NewWechatWeb("appid", "secret", "https://example.com/callback")
	if err != nil {
	...
	if p.Name() != "wechat_web" {
		t.Errorf("Name() = %q, want %q", p.Name(), "wechat_web")
	}
}

func TestNewWechatWeb_WithOptions(t *testing.T) {
	client := &http.Client{}
	logger := &noopLogger{}
	p, err := NewWechatWeb("appid", "secret", "https://example.com/callback",
...
func TestNewWechatWeb_EmptyAppID(t *testing.T) {
	_, err := NewWechatWeb("", "secret", "https://example.com/callback")
	if err == nil {
...
func TestNewWechatWeb_EmptySecret(t *testing.T) {
	_, err := NewWechatWeb("appid", "", "https://example.com/callback")
	if err == nil {
...
func TestNewWechatWeb_EmptyRedirectURL(t *testing.T) {
	_, err := NewWechatWeb("appid", "secret", "")
	if err == nil {
...
func TestWechatWebProvider_Name(t *testing.T) {
	p, _ := NewWechatWeb("appid", "secret", "https://example.com/callback")
	if p.Name() != "wechat_web" {
		t.Errorf("Name() = %q, want %q", p.Name(), "wechat_web")
	}
}
...
func TestWechatWebProvider_AuthURL_Success(t *testing.T) {
	p, _ := NewWechatWeb("test_appid", "secret", "https://example.com/callback")
	...
	if q.Get("scope") != "snsapi_login" {
		t.Errorf("scope = %q, want %q", q.Get("scope"), "snsapi_login")
	}
...
func TestWechatWebProvider_AuthURL_EmptyState(t *testing.T) {
	p, _ := NewWechatWeb("appid", "secret", "https://example.com/callback")
...
func TestWechatWebProvider_AuthURL_RedirectURIEncoded(t *testing.T) {
	p, _ := NewWechatWeb("appid", "secret", "https://example.com/callback?foo=bar&baz=1")
...
func TestWechatWebProvider_AuthURL_StateEncoded(t *testing.T) {
	p, _ := NewWechatWeb("appid", "secret", "https://example.com/callback")
...
func TestWechatWebProvider_ExchangeCode_EmptyCode(t *testing.T) {
	p := &wechatWebProvider{
...
func TestWechatWebProvider_ExchangeCode_Success(t *testing.T) {
	resp := map[string]any{
...
func TestWechatWebProvider_ExchangeCode_APIError(t *testing.T) {
	resp := map[string]any{
		"errcode": 40029,
		"errmsg":  "invalid code",
	}
...
func TestWechatWebProvider_GetUserInfo_Success(t *testing.T) {
	resp := map[string]any{
		"openid":     "oTestOpenID",
		"unionid":    "oTestUnionID",
		"nickname":   "TestUser",
...
func TestWechatWebProvider_GetUserInfo_APIError(t *testing.T) {
	resp := map[string]any{
		"errcode": 42001,
...
func TestWechatWebProvider_RefreshToken_Success(t *testing.T) {
	resp := map[string]any{
...
func TestWechatWebProvider_RefreshToken_APIError(t *testing.T) {
	resp := map[string]any{
		"errcode": 42002,
...
func TestWechatWebProvider_GetUserInfo_NilToken(t *testing.T) {
	p := &wechatWebProvider{
		wechatBaseProvider: wechatBaseProvider{
			appID:  "appid",
			secret: "secret",
...
func TestWechatWebProvider_GetUserInfo_WithDefaultLang(t *testing.T) {
	ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		q := r.URL.Query()
		if q.Get("lang") != "en" {
	...
	p, err := NewWechatWeb("appid", "secret", "https://example.com/callback", withDefaultLang("en"))
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	// Override apiBase and httpClient for testing.
	wp := p.(*wechatWebProvider)
	wp.apiBase = ts.URL
	wp.httpClient = ts.Client()

	info, err := p.GetUserInfo(context.Background(), &Token{AccessToken: "tok", OpenID: "oTestOpenID"})
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if info.OpenID != "oTestOpenID" {
...
func TestWechatWebProvider_RefreshToken_EmptyRefreshToken(t *testing.T) {
	p := &wechatWebProvider{
		wechatBaseProvider: wechatBaseProvider{
			appID:  "appid",
			secret: "secret",
...
func TestWechatWebProvider_ImplementsProvider(t *testing.T) {
	var _ Provider = (*wechatWebProvider)(nil)
}
...
func TestWechatWebProvider_ExchangeCode_TokenExpired(t *testing.T) {
	resp := map[string]any{
		"errcode": 42001,
		"errmsg":  "access_token expired",
	}
...
func TestWechatWebProvider_Concurrency(t *testing.T) {
	resp := map[string]any{
